...
const SPLASH_TEXTS = [
  ...
  { text: "Heavily Into Birds !", weight: 5 },
  { text: "Buy 100 Commissions Get Your 1001st Free !", weight: 5 },
  { text: "Worm on a string ! 🪱", weight: 5 },
  ...
  { text: "Stay Curious", weight: 5 },
  { text: "Rate 5 Stars !", weight: 4 },
  ...
  { text: "You Betta Werk !", weight: 2 },
  { text: "Pieces Pieces , All Gone !", weight: 2 },
